		...
		<div class="col-container">
			<div class="wrapper">
				<div class="bloc-top auth" style="height: 580px">
					...
					<form:form action="${pageContext.request.contextPath}/demande" id="requestForm" modelAttribute="requestForm" method="post">
						...
						<input id="pays" maxlength="50" name="country" placeholder="Pays où vous voulez trouver un hebergement* " type="text" value="" />
						
						<input id="ville" maxlength="50" name="city" placeholder="Ville où vous voulez trouver un hebergement* " type="text" value="" />
						
						<input id="rue" maxlength="50" name="street" placeholder="Rue où vous voulez trouver un hebergement*" type="text" value="" />
						
						<textarea name="description" rows="4" cols="41" placeholder="Décrivez votre demande ici..."></textarea>
						
						<input type="hidden" name="status" value="1"/>

						<input id="bt-auth" type="submit" class="validBtn" value="Savegerdez" style="position: relative; left: -290px; top: 30px" /> 
